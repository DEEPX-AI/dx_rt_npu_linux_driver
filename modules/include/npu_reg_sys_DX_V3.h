 ...
 *
 */
#ifndef __NPU_REG_SYSTEM_DX_V3_H
#define __NPU_REG_SYSTEM_DX_V3_H

#include <linux/types.h>

/* Definition */
#define MODEL_TYPE_NON_PPU 1
#define MODEL_TYPE_PPU     2


/* Control Address */
#define REG_CONTROL_OFFSET 0x0
#define REG_CONTROL_RESET    (REG_CONTROL_OFFSET + 0x00000000) /* 0 */
#define REG_CONTROL_CLOCK    (REG_CONTROL_OFFSET + 0x00000004) /* 4 */
#define REG_CONTROL_NONSEC   (REG_CONTROL_OFFSET + 0x00000008) /* 8 */

#define CONTROL_RESET_OFFSET     0
#define CONTROL_CLOCK_OFFSET     0
#define CONTROL_NONSEC_OFFSET    1

#define CONTROL_RESET_MASK    0x0000000f /* [3:0] 0b00000000000000000000000000001111 */
#define CONTROL_CLOCK_MASK    0x0000000f /* [3:0] 0b00000000000000000000000000001111 */
#define CONTROL_NONSEC_MASK   0x00000006 /* [2:1] 0b00000000000000000000000000000110 */

#define WRITE_CONTROL_RESET(base, val)  npu_reg_write_mask(base, REG_CONTROL_RESET,  val, CONTROL_RESET_MASK,  CONTROL_RESET_OFFSET)
#define WRITE_CONTROL_CLOCK(base, val)  npu_reg_write_mask(base, REG_CONTROL_CLOCK,  val, CONTROL_CLOCK_MASK,  CONTROL_CLOCK_OFFSET)
#define WRITE_CONTROL_NONSEC(base, val) npu_reg_write_mask(base, REG_CONTROL_NONSEC, val, CONTROL_NONSEC_MASK, CONTROL_NONSEC_OFFSET)
/*~Control Address */
...
#define REG_SYSTEM_STATUS3    (REG_SYSTEM_OFFSET + 0x00000010) /* 16 */
#define REG_SYSTEM_NET_INFO    (REG_SYSTEM_OFFSET + 0x00000014) /* 20 */
#define REG_SYSTEM_IRQ_STATUS    (REG_SYSTEM_OFFSET + 0x00000018) /* 24 */
#define REG_SYSTEM_IRQ_SET    (REG_SYSTEM_OFFSET + 0x0000001c) /* 28 */
#define REG_SYSTEM_IRQ_CNT0    (REG_SYSTEM_OFFSET + 0x00000020) /* 32 */
#define REG_SYSTEM_IRQ_CNT1    (REG_SYSTEM_OFFSET + 0x00000024) /* 36 */
#define REG_SYSTEM_IRQ_CNT2    (REG_SYSTEM_OFFSET + 0x00000028) /* 40 */
#define REG_SYSTEM_IN_FEATURE_BASE    (REG_SYSTEM_OFFSET + 0x0000002c) /* 44 */
#define REG_SYSTEM_OUT_FEATURE_BASE    (REG_SYSTEM_OFFSET + 0x00000030) /* 48 */
#define REG_SYSTEM_WEIGHT_BASE    (REG_SYSTEM_OFFSET + 0x00000034) /* 52 */
#define REG_SYSTEM_IRQ_TIMER_DMA    (REG_SYSTEM_OFFSET + 0x00000038) /* 56 */
#define REG_SYSTEM_IRQ_TIMER_OP    (REG_SYSTEM_OFFSET + 0x0000003c) /* 60 */
#define REG_SYSTEM_CMD    (REG_SYSTEM_OFFSET + 0x00000040) /* 64 */
#define REG_SYSTEM_PPU_OUT_FILTER_INFO    (REG_SYSTEM_OFFSET + 0x00000044) /* 68 */
#define REG_SYSTEM_PPU_OUT_FEATURE_BASE    (REG_SYSTEM_OFFSET + 0x00000048) /* 72 */
#define REG_SYSTEM_SWREG0    (REG_SYSTEM_OFFSET + 0x0000004c) /* 76 */
#define REG_SYSTEM_SWREG1    (REG_SYSTEM_OFFSET + 0x00000050) /* 80 */
#define REG_SYSTEM_SWREG2    (REG_SYSTEM_OFFSET + 0x00000054) /* 84 */
#define REG_SYSTEM_SWREG3    (REG_SYSTEM_OFFSET + 0x00000058) /* 88 */
#define REG_SYSTEM_SWREG4    (REG_SYSTEM_OFFSET + 0x0000005c) /* 92 */
#define REG_SYSTEM_SWREG5    (REG_SYSTEM_OFFSET + 0x00000060) /* 96 */
#define REG_SYSTEM_SWREG6    (REG_SYSTEM_OFFSET + 0x00000064) /* 100 */
#define REG_SYSTEM_SWREG7    (REG_SYSTEM_OFFSET + 0x00000068) /* 104 */
#define REG_SYSTEM_SWREG8    (REG_SYSTEM_OFFSET + 0x0000006c) /* 108 */
#define REG_SYSTEM_SWREG9    (REG_SYSTEM_OFFSET + 0x00000070) /* 112 */
#define REG_SYSTEM_SWREG10    (REG_SYSTEM_OFFSET + 0x00000074) /* 116 */
#define REG_SYSTEM_SWREG11    (REG_SYSTEM_OFFSET + 0x00000078) /* 120 */
#define REG_SYSTEM_SWREG12    (REG_SYSTEM_OFFSET + 0x0000007c) /* 124 */
#define REG_SYSTEM_SWREG13    (REG_SYSTEM_OFFSET + 0x00000080) /* 128 */
#define REG_SYSTEM_SWREG14    (REG_SYSTEM_OFFSET + 0x00000084) /* 132 */
#define REG_SYSTEM_SWREG15    (REG_SYSTEM_OFFSET + 0x00000088) /* 136 */
#define REG_SYSTEM_RSVD0    (REG_SYSTEM_OFFSET + 0x0000008c) /* 140 */
#define REG_SYSTEM_RSVD1    (REG_SYSTEM_OFFSET + 0x00000090) /* 144 */
#define REG_SYSTEM_RSVD2    (REG_SYSTEM_OFFSET + 0x00000094) /* 148 */
...
typedef volatile union _SYSTEM_ID_t
{
    ...
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t RMAP_ID:16;  /* SYSTEM.ID.RMAP_ID [15:0] (R, 0x6) RMAP VERSION */
        volatile uint32_t REVISION_ID:6;  /* SYSTEM.ID.REVISION_ID [21:16] (R, 0x0) RTL REVISION # */
        volatile uint32_t NPU_ID:2;  /* SYSTEM.ID.NPU_ID [23:22] (R, 0x0)  */
        volatile uint32_t DEVICE_ID:8;  /* SYSTEM.ID.DEVICE_ID [31:24] (R, 0xa5) L1:A1, L2:A2, L3:A3, L4:A4, V3:A5, M1:B1, M1A:B2 */
    };
} SYSTEM_ID_t;
typedef volatile union _SYSTEM_RUN_OPT_t
{
    ...
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t AUTORUN_EN:1;  /* SYSTEM.RUN_OPT.AUTORUN_EN [0:0] (RW, 0x0) INFERENCE 종료 後, NEXT INFERENCE 자동 START */
        volatile uint32_t RESERVED0:31;  /* SYSTEM.RUN_OPT.RESERVED0 [31:1] (R, 0x0)  */
    };
} SYSTEM_RUN_OPT_t;
typedef volatile union _SYSTEM_STATUS1_t
{
    ...
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t ARGMAX_ID:16;  /* SYSTEM.STATUS1.ARGMAX_ID [15:0] (R, 0x0) 최종 검출된 CLASS INDEX NO.(IC MODEL) */
        volatile uint32_t RESERVED0:16;  /* SYSTEM.STATUS1.RESERVED0 [31:16] (R, 0x0)  */
    };
} SYSTEM_STATUS1_t;
typedef volatile union _SYSTEM_STATUS2_t
{
    ...
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t CMD_NUM:18;  /* SYSTEM.STATUS2.CMD_NUM [17:0] (R, 0x0) 현재 수행중인 TILE NO.(0~) */
        volatile uint32_t RESERVED0:14;  /* SYSTEM.STATUS2.RESERVED0 [31:18] (R, 0x0)  */
    };
} SYSTEM_STATUS2_t;
typedef volatile union _SYSTEM_STATUS3_t
{
    volatile uint32_t U;  /* Register-Access : SYSTEM.STATUS3*/
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t BUSY:1;  /* SYSTEM.STATUS3.BUSY [0:0] (R, 0x0) NPU 동작상태 */
        volatile uint32_t RESERVED0:31;  /* SYSTEM.STATUS3.RESERVED0 [31:1] (R, 0x0)  */
    };
} SYSTEM_STATUS3_t;
typedef volatile union _SYSTEM_NET_INFO_t
{
    ...
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t LAST_CMD_NUM:18;  /* SYSTEM.NET_INFO.LAST_CMD_NUM [17:0] (RW, 0x0) NETWORK 구동에 사용되는 RMAP TILE 개수 */
        volatile uint32_t RESERVED0:14;  /* SYSTEM.NET_INFO.RESERVED0 [31:18] (R, 0x0)  */
    };
} SYSTEM_NET_INFO_t;
typedef volatile union _SYSTEM_IRQ_STATUS_t
{
    ...
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t STATUS_TILE:18;  /* SYSTEM.IRQ_STATUS.STATUS_TILE [17:0] (R, 0x0) IRQ 발생 TILE NO.(ONLY ABNORMAL IRQ 만, FRAME/TILE/INPUT_DONE 제외) */
        volatile uint32_t STATUS_OP:4;  /* SYSTEM.IRQ_STATUS.STATUS_OP [21:18] (R, 0x0) IRQ 발생 TILE OPERATION(ONLY ABNORMAL IRQ 만, FRAME/TILE/INPUT_DONE 제외) */
        volatile uint32_t RESERVED0:6;  /* SYSTEM.IRQ_STATUS.RESERVED0 [27:22] (R, 0x0)  */
        volatile uint32_t IRQ_ERR:1;  /* SYSTEM.IRQ_STATUS.IRQ_ERR [28:28] (R, 0x0)  */
...
typedef volatile union _SYSTEM_IRQ_SET_t
{
    ...
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t RESERVED0:28;  /* SYSTEM.IRQ_SET.RESERVED0 [27:0] (R, 0x0)  */
        volatile uint32_t IRQ_ERR_SET:1;  /* SYSTEM.IRQ_SET.IRQ_ERR_SET [28:28] (RW, 0x0) 1: NPU OUTPUT 반영, 0: 내부 MONITORING만 사용 */
...
typedef volatile union _SYSTEM_IRQ_CNT0_t
{
    ...
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t IRQ_CNT_NPU_FRAME:32;  /* SYSTEM.IRQ_CNT0.IRQ_CNT_NPU_FRAME [31:0] (R, 0x0) IRQ_FRAME COUNT */
    };
} SYSTEM_IRQ_CNT0_t;
typedef volatile union _SYSTEM_IRQ_CNT1_t
{
    ...
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t IRQ_CNT_NPU_INPUT_DONE:32;  /* SYSTEM.IRQ_CNT1.IRQ_CNT_NPU_INPUT_DONE [31:0] (R, 0x0) IRQ_INPUT_DONE COUNT */
    };
} SYSTEM_IRQ_CNT1_t;
typedef volatile union _SYSTEM_IRQ_CNT2_t
{
    ...
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t IRQ_CNT_NPU_ERR:32;  /* SYSTEM.IRQ_CNT2.IRQ_CNT_NPU_ERR [31:0] (R, 0x0)  */
    };
} SYSTEM_IRQ_CNT2_t;
...
typedef volatile union _SYSTEM_PPU_OUT_FILTER_INFO_t
{
    ...
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t PPU_FILTERING_NUM:16;  /* SYSTEM.PPU_OUT_FILTER_INFO.PPU_FILTERING_NUM [15:0] (R, 0x0) TOTAL NUMBER OF PP_FILTERING RESULT COUNTS(WRITE BY M4 CPU) */
        volatile uint32_t PPU_FILTERING_WNUM:16;  /* SYSTEM.PPU_OUT_FILTER_INFO.PPU_FILTERING_WNUM [31:16] (R, 0x0)  */
    };
...
typedef volatile union _SYSTEM_PPU_OUT_FEATURE_BASE_t
{
    ...
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t PPU_OUT_FEATURE_OFFSET:32;  /* SYSTEM.PPU_OUT_FEATURE_BASE.PPU_OUT_FEATURE_OFFSET [31:0] (RW, 0x0) POST-PROCESS 최종 OUTPUT(BOX INFO) DDR BASE ADDRESS */
    };
...
typedef volatile union _SYSTEM_RSVD0_t
{
    volatile uint32_t U;  /* Register-Access : SYSTEM.RSVD0*/
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t RESERVED0:32;  /* SYSTEM.RSVD0.RESERVED0 [31:0] (R, 0x0)  */
    };
} SYSTEM_RSVD0_t;
typedef volatile union _SYSTEM_RSVD1_t
{
    volatile uint32_t U;  /* Register-Access : SYSTEM.RSVD1*/
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t RESERVED0:32;  /* SYSTEM.RSVD1.RESERVED0 [31:0] (R, 0x0)  */
    };
} SYSTEM_RSVD1_t;
typedef volatile union _SYSTEM_RSVD2_t
{
    volatile uint32_t U;  /* Register-Access : SYSTEM.RSVD2*/
    struct {     /* Register-Bitfields-Access */
        volatile uint32_t RESERVED0:32;  /* SYSTEM.RSVD2.RESERVED0 [31:0] (R, 0x0)  */
    };
} SYSTEM_RSVD2_t;
...
typedef volatile struct _dxSYSTEM_t
{
    ...
    SYSTEM_STATUS3_t STATUS3;  /* SYSTEM 0x10 */
    SYSTEM_NET_INFO_t NET_INFO;  /* SYSTEM 0x14 */
    SYSTEM_IRQ_STATUS_t IRQ_STATUS;  /* SYSTEM 0x18 */
    SYSTEM_IRQ_SET_t IRQ_SET;  /* SYSTEM 0x1c */
    SYSTEM_IRQ_CNT0_t IRQ_CNT0;  /* SYSTEM 0x20 */
    SYSTEM_IRQ_CNT1_t IRQ_CNT1;  /* SYSTEM 0x24 */
    SYSTEM_IRQ_CNT2_t IRQ_CNT2;  /* SYSTEM 0x28 */
    SYSTEM_IN_FEATURE_BASE_t IN_FEATURE_BASE;  /* SYSTEM 0x2c */
    SYSTEM_OUT_FEATURE_BASE_t OUT_FEATURE_BASE;  /* SYSTEM 0x30 */
    SYSTEM_WEIGHT_BASE_t WEIGHT_BASE;  /* SYSTEM 0x34 */
    SYSTEM_IRQ_TIMER_DMA_t IRQ_TIMER_DMA;  /* SYSTEM 0x38 */
    SYSTEM_IRQ_TIMER_OP_t IRQ_TIMER_OP;  /* SYSTEM 0x3c */
    SYSTEM_CMD_t CMD;  /* SYSTEM 0x40 */
    SYSTEM_PPU_OUT_FILTER_INFO_t PPU_OUT_FILTER_INFO;  /* SYSTEM 0x44 */
    SYSTEM_PPU_OUT_FEATURE_BASE_t PPU_OUT_FEATURE_BASE;  /* SYSTEM 0x48 */
    SYSTEM_SWREG0_t SWREG0;  /* SYSTEM 0x4c */
    SYSTEM_SWREG1_t SWREG1;  /* SYSTEM 0x50 */
    SYSTEM_SWREG2_t SWREG2;  /* SYSTEM 0x54 */
    SYSTEM_SWREG3_t SWREG3;  /* SYSTEM 0x58 */
    SYSTEM_SWREG4_t SWREG4;  /* SYSTEM 0x5c */
    SYSTEM_SWREG5_t SWREG5;  /* SYSTEM 0x60 */
    SYSTEM_SWREG6_t SWREG6;  /* SYSTEM 0x64 */
    SYSTEM_SWREG7_t SWREG7;  /* SYSTEM 0x68 */
    SYSTEM_SWREG8_t SWREG8;  /* SYSTEM 0x6c */
    SYSTEM_SWREG9_t SWREG9;  /* SYSTEM 0x70 */
    SYSTEM_SWREG10_t SWREG10;  /* SYSTEM 0x74 */
    SYSTEM_SWREG11_t SWREG11;  /* SYSTEM 0x78 */
    SYSTEM_SWREG12_t SWREG12;  /* SYSTEM 0x7c */
    SYSTEM_SWREG13_t SWREG13;  /* SYSTEM 0x80 */
    SYSTEM_SWREG14_t SWREG14;  /* SYSTEM 0x84 */
    SYSTEM_SWREG15_t SWREG15;  /* SYSTEM 0x88 */
    SYSTEM_RSVD0_t RSVD0;  /* SYSTEM 0x8c */
    SYSTEM_RSVD1_t RSVD1;  /* SYSTEM 0x90 */
    SYSTEM_RSVD2_t RSVD2;  /* SYSTEM 0x94 */
} dxSYSTEM_t;
...
/* SYSTEM.ID.NPU_ID (Category: SYSTEM) */
#define SYSTEM_ID_NPU_ID_LEN        2
#define SYSTEM_ID_NPU_ID_OFFSET     22
#define SYSTEM_ID_NPU_ID_MASK_BITS  0x00000003 /* [1:0] 0b00000000000000000000000000000011 */
#define SYSTEM_ID_NPU_ID_MASK       0x00c00000 /* [23:22] 0b00000000110000000000000000000000 */

#define READ_SYSTEM_ID_NPU_ID(base) \
    npu_reg_read_mask(base, REG_SYSTEM_ID, SYSTEM_ID_NPU_ID_MASK, SYSTEM_ID_NPU_ID_OFFSET)
#define WRITE_SYSTEM_ID_NPU_ID(base, val) \
    npu_reg_write_mask(base, REG_SYSTEM_ID, val, SYSTEM_ID_NPU_ID_MASK, SYSTEM_ID_NPU_ID_OFFSET)
...
#define SYSTEM_RUN_OPT_AUTORUN_EN_OFFSET     0
#define SYSTEM_RUN_OPT_AUTORUN_EN_MASK_BITS  0x00000001 /* [0:0] 0b00000000000000000000000000000001 */
#define SYSTEM_RUN_OPT_AUTORUN_EN_MASK       0x00000001 /* [0:0] 0b00000000000000000000000000000001 */
...
#define SYSTEM_RUN_OPT_RESERVED0_OFFSET     1
#define SYSTEM_RUN_OPT_RESERVED0_MASK_BITS  0x7fffffff /* [30:0] 0b01111111111111111111111111111111 */
#define SYSTEM_RUN_OPT_RESERVED0_MASK       0xfffffffe /* [31:1] 0b11111111111111111111111111111110 */
...
#define SYSTEM_STATUS1_ARGMAX_ID_OFFSET     0
#define SYSTEM_STATUS1_ARGMAX_ID_MASK_BITS  0x0000ffff /* [15:0] 0b00000000000000001111111111111111 */
#define SYSTEM_STATUS1_ARGMAX_ID_MASK       0x0000ffff /* [15:0] 0b00000000000000001111111111111111 */
...
/* SYSTEM.STATUS1.RESERVED0 (Category: SYSTEM) */
#define SYSTEM_STATUS1_RESERVED0_LEN        16
#define SYSTEM_STATUS1_RESERVED0_OFFSET     16
#define SYSTEM_STATUS1_RESERVED0_MASK_BITS  0x0000ffff /* [15:0] 0b00000000000000001111111111111111 */
#define SYSTEM_STATUS1_RESERVED0_MASK       0xffff0000 /* [31:16] 0b11111111111111110000000000000000 */

#define READ_SYSTEM_STATUS1_RESERVED0(base) \
    npu_reg_read_mask(base, REG_SYSTEM_STATUS1, SYSTEM_STATUS1_RESERVED0_MASK, SYSTEM_STATUS1_RESERVED0_OFFSET)
#define WRITE_SYSTEM_STATUS1_RESERVED0(base, val) \
    npu_reg_write_mask(base, REG_SYSTEM_STATUS1, val, SYSTEM_STATUS1_RESERVED0_MASK, SYSTEM_STATUS1_RESERVED0_OFFSET)
...
/* SYSTEM.STATUS2.CMD_NUM (Category: SYSTEM) */
#define SYSTEM_STATUS2_CMD_NUM_LEN        18
#define SYSTEM_STATUS2_CMD_NUM_OFFSET     0
#define SYSTEM_STATUS2_CMD_NUM_MASK_BITS  0x0003ffff /* [17:0] 0b00000000000000111111111111111111 */
#define SYSTEM_STATUS2_CMD_NUM_MASK       0x0003ffff /* [17:0] 0b00000000000000111111111111111111 */

#define READ_SYSTEM_STATUS2_CMD_NUM(base) \
    npu_reg_read_mask(base, REG_SYSTEM_STATUS2, SYSTEM_STATUS2_CMD_NUM_MASK, SYSTEM_STATUS2_CMD_NUM_OFFSET)
#define WRITE_SYSTEM_STATUS2_CMD_NUM(base, val) \
    npu_reg_write_mask(base, REG_SYSTEM_STATUS2, val, SYSTEM_STATUS2_CMD_NUM_MASK, SYSTEM_STATUS2_CMD_NUM_OFFSET)

/* SYSTEM.STATUS2.RESERVED0 (Category: SYSTEM) */
#define SYSTEM_STATUS2_RESERVED0_LEN        14
#define SYSTEM_STATUS2_RESERVED0_OFFSET     18
#define SYSTEM_STATUS2_RESERVED0_MASK_BITS  0x00003fff /* [13:0] 0b00000000000000000011111111111111 */
#define SYSTEM_STATUS2_RESERVED0_MASK       0xfffc0000 /* [31:18] 0b11111111111111000000000000000000 */
...
/* SYSTEM.STATUS3 (Category: SYSTEM) */
#define READ_SYSTEM_STATUS3(base) npu_reg_read(base, REG_SYSTEM_STATUS3)
#define WRITE_SYSTEM_STATUS3(base, val) npu_reg_write(base, REG_SYSTEM_STATUS3, val)
/* SYSTEM.STATUS3.BUSY (Category: SYSTEM) */
#define SYSTEM_STATUS3_BUSY_LEN        1
#define SYSTEM_STATUS3_BUSY_OFFSET     0
#define SYSTEM_STATUS3_BUSY_MASK_BITS  0x00000001 /* [0:0] 0b00000000000000000000000000000001 */
#define SYSTEM_STATUS3_BUSY_MASK       0x00000001 /* [0:0] 0b00000000000000000000000000000001 */

#define READ_SYSTEM_STATUS3_BUSY(base) \
    npu_reg_read_mask(base, REG_SYSTEM_STATUS3, SYSTEM_STATUS3_BUSY_MASK, SYSTEM_STATUS3_BUSY_OFFSET)
#define WRITE_SYSTEM_STATUS3_BUSY(base, val) \
    npu_reg_write_mask(base, REG_SYSTEM_STATUS3, val, SYSTEM_STATUS3_BUSY_MASK, SYSTEM_STATUS3_BUSY_OFFSET)

/* SYSTEM.STATUS3.RESERVED0 (Category: SYSTEM) */
#define SYSTEM_STATUS3_RESERVED0_LEN        31
#define SYSTEM_STATUS3_RESERVED0_OFFSET     1
#define SYSTEM_STATUS3_RESERVED0_MASK_BITS  0x7fffffff /* [30:0] 0b01111111111111111111111111111111 */
#define SYSTEM_STATUS3_RESERVED0_MASK       0xfffffffe /* [31:1] 0b11111111111111111111111111111110 */

#define READ_SYSTEM_STATUS3_RESERVED0(base) \
    npu_reg_read_mask(base, REG_SYSTEM_STATUS3, SYSTEM_STATUS3_RESERVED0_MASK, SYSTEM_STATUS3_RESERVED0_OFFSET)
#define WRITE_SYSTEM_STATUS3_RESERVED0(base, val) \
    npu_reg_write_mask(base, REG_SYSTEM_STATUS3, val, SYSTEM_STATUS3_RESERVED0_MASK, SYSTEM_STATUS3_RESERVED0_OFFSET)
...
#define SYSTEM_NET_INFO_LAST_CMD_NUM_LEN        18
#define SYSTEM_NET_INFO_LAST_CMD_NUM_OFFSET     0
#define SYSTEM_NET_INFO_LAST_CMD_NUM_MASK_BITS  0x0003ffff /* [17:0] 0b00000000000000111111111111111111 */
#define SYSTEM_NET_INFO_LAST_CMD_NUM_MASK       0x0003ffff /* [17:0] 0b00000000000000111111111111111111 */
...
#define SYSTEM_NET_INFO_RESERVED0_LEN        14
#define SYSTEM_NET_INFO_RESERVED0_OFFSET     18
#define SYSTEM_NET_INFO_RESERVED0_MASK_BITS  0x00003fff /* [13:0] 0b00000000000000000011111111111111 */
#define SYSTEM_NET_INFO_RESERVED0_MASK       0xfffc0000 /* [31:18] 0b11111111111111000000000000000000 */
...
#define SYSTEM_IRQ_STATUS_STATUS_TILE_LEN        18
#define SYSTEM_IRQ_STATUS_STATUS_TILE_OFFSET     0
#define SYSTEM_IRQ_STATUS_STATUS_TILE_MASK_BITS  0x0003ffff /* [17:0] 0b00000000000000111111111111111111 */
#define SYSTEM_IRQ_STATUS_STATUS_TILE_MASK       0x0003ffff /* [17:0] 0b00000000000000111111111111111111 */
...
#define SYSTEM_IRQ_STATUS_STATUS_OP_OFFSET     18
#define SYSTEM_IRQ_STATUS_STATUS_OP_MASK_BITS  0x0000000f /* [3:0] 0b00000000000000000000000000001111 */
#define SYSTEM_IRQ_STATUS_STATUS_OP_MASK       0x003c0000 /* [21:18] 0b00000000001111000000000000000000 */
...
#define SYSTEM_IRQ_STATUS_RESERVED0_LEN        6
#define SYSTEM_IRQ_STATUS_RESERVED0_OFFSET     22
#define SYSTEM_IRQ_STATUS_RESERVED0_MASK_BITS  0x0000003f /* [5:0] 0b00000000000000000000000000111111 */
#define SYSTEM_IRQ_STATUS_RESERVED0_MASK       0x0fc00000 /* [27:22] 0b00001111110000000000000000000000 */
...
/* SYSTEM.IRQ_STATUS.IRQ_ERR (Category: SYSTEM) */
#define SYSTEM_IRQ_STATUS_IRQ_ERR_LEN        1
#define SYSTEM_IRQ_STATUS_IRQ_ERR_OFFSET     28
#define SYSTEM_IRQ_STATUS_IRQ_ERR_MASK_BITS  0x00000001 /* [0:0] 0b00000000000000000000000000000001 */
#define SYSTEM_IRQ_STATUS_IRQ_ERR_MASK       0x10000000 /* [28:28] 0b00010000000000000000000000000000 */

#define READ_SYSTEM_IRQ_STATUS_IRQ_ERR(base) \
    npu_reg_read_mask(base, REG_SYSTEM_IRQ_STATUS, SYSTEM_IRQ_STATUS_IRQ_ERR_MASK, SYSTEM_IRQ_STATUS_IRQ_ERR_OFFSET)
#define WRITE_SYSTEM_IRQ_STATUS_IRQ_ERR(base, val) \
    npu_reg_write_mask(base, REG_SYSTEM_IRQ_STATUS, val, SYSTEM_IRQ_STATUS_IRQ_ERR_MASK, SYSTEM_IRQ_STATUS_IRQ_ERR_OFFSET)
...
#define SYSTEM_IRQ_SET_RESERVED0_LEN        28
#define SYSTEM_IRQ_SET_RESERVED0_OFFSET     0
#define SYSTEM_IRQ_SET_RESERVED0_MASK_BITS  0x0fffffff /* [27:0] 0b00001111111111111111111111111111 */
#define SYSTEM_IRQ_SET_RESERVED0_MASK       0x0fffffff /* [27:0] 0b00001111111111111111111111111111 */
...
/* SYSTEM.IRQ_SET.IRQ_ERR_SET (Category: SYSTEM) */
#define SYSTEM_IRQ_SET_IRQ_ERR_SET_LEN        1
#define SYSTEM_IRQ_SET_IRQ_ERR_SET_OFFSET     28
#define SYSTEM_IRQ_SET_IRQ_ERR_SET_MASK_BITS  0x00000001 /* [0:0] 0b00000000000000000000000000000001 */
#define SYSTEM_IRQ_SET_IRQ_ERR_SET_MASK       0x10000000 /* [28:28] 0b00010000000000000000000000000000 */

#define READ_SYSTEM_IRQ_SET_IRQ_ERR_SET(base) \
    npu_reg_read_mask(base, REG_SYSTEM_IRQ_SET, SYSTEM_IRQ_SET_IRQ_ERR_SET_MASK, SYSTEM_IRQ_SET_IRQ_ERR_SET_OFFSET)
#define WRITE_SYSTEM_IRQ_SET_IRQ_ERR_SET(base, val) \
    npu_reg_write_mask(base, REG_SYSTEM_IRQ_SET, val, SYSTEM_IRQ_SET_IRQ_ERR_SET_MASK, SYSTEM_IRQ_SET_IRQ_ERR_SET_OFFSET)
...
/* SYSTEM.IRQ_CNT0.IRQ_CNT_NPU_FRAME (Category: SYSTEM) */
#define SYSTEM_IRQ_CNT0_IRQ_CNT_NPU_FRAME_LEN        32
#define SYSTEM_IRQ_CNT0_IRQ_CNT_NPU_FRAME_OFFSET     0
#define SYSTEM_IRQ_CNT0_IRQ_CNT_NPU_FRAME_MASK_BITS  0xffffffff /* [31:0] 0b11111111111111111111111111111111 */
#define SYSTEM_IRQ_CNT0_IRQ_CNT_NPU_FRAME_MASK       0xffffffff /* [31:0] 0b11111111111111111111111111111111 */

#define READ_SYSTEM_IRQ_CNT0_IRQ_CNT_NPU_FRAME(base) \
    npu_reg_read_mask(base, REG_SYSTEM_IRQ_CNT0, SYSTEM_IRQ_CNT0_IRQ_CNT_NPU_FRAME_MASK, SYSTEM_IRQ_CNT0_IRQ_CNT_NPU_FRAME_OFFSET)
#define WRITE_SYSTEM_IRQ_CNT0_IRQ_CNT_NPU_FRAME(base, val) \
    npu_reg_write_mask(base, REG_SYSTEM_IRQ_CNT0, val, SYSTEM_IRQ_CNT0_IRQ_CNT_NPU_FRAME_MASK, SYSTEM_IRQ_CNT0_IRQ_CNT_NPU_FRAME_OFFSET)
...
/* SYSTEM.IRQ_CNT2.IRQ_CNT_NPU_ERR (Category: SYSTEM) */
#define SYSTEM_IRQ_CNT2_IRQ_CNT_NPU_ERR_LEN        32
#define SYSTEM_IRQ_CNT2_IRQ_CNT_NPU_ERR_OFFSET     0
#define SYSTEM_IRQ_CNT2_IRQ_CNT_NPU_ERR_MASK_BITS  0xffffffff /* [31:0] 0b11111111111111111111111111111111 */
#define SYSTEM_IRQ_CNT2_IRQ_CNT_NPU_ERR_MASK       0xffffffff /* [31:0] 0b11111111111111111111111111111111 */

#define READ_SYSTEM_IRQ_CNT2_IRQ_CNT_NPU_ERR(base) \
    npu_reg_read_mask(base, REG_SYSTEM_IRQ_CNT2, SYSTEM_IRQ_CNT2_IRQ_CNT_NPU_ERR_MASK, SYSTEM_IRQ_CNT2_IRQ_CNT_NPU_ERR_OFFSET)
#define WRITE_SYSTEM_IRQ_CNT2_IRQ_CNT_NPU_ERR(base, val) \
    npu_reg_write_mask(base, REG_SYSTEM_IRQ_CNT2, val, SYSTEM_IRQ_CNT2_IRQ_CNT_NPU_ERR_MASK, SYSTEM_IRQ_CNT2_IRQ_CNT_NPU_ERR_OFFSET)
...
/* SYSTEM.RSVD0 (Category: SYSTEM) */
#define READ_SYSTEM_RSVD0(base) npu_reg_read(base, REG_SYSTEM_RSVD0)
#define WRITE_SYSTEM_RSVD0(base, val) npu_reg_write(base, REG_SYSTEM_RSVD0, val)
/* SYSTEM.RSVD0.RESERVED0 (Category: SYSTEM) */
#define SYSTEM_RSVD0_RESERVED0_LEN        32
#define SYSTEM_RSVD0_RESERVED0_OFFSET     0
#define SYSTEM_RSVD0_RESERVED0_MASK_BITS  0xffffffff /* [31:0] 0b11111111111111111111111111111111 */
#define SYSTEM_RSVD0_RESERVED0_MASK       0xffffffff /* [31:0] 0b11111111111111111111111111111111 */

#define READ_SYSTEM_RSVD0_RESERVED0(base) \
    npu_reg_read_mask(base, REG_SYSTEM_RSVD0, SYSTEM_RSVD0_RESERVED0_MASK, SYSTEM_RSVD0_RESERVED0_OFFSET)
#define WRITE_SYSTEM_RSVD0_RESERVED0(base, val) \
    npu_reg_write_mask(base, REG_SYSTEM_RSVD0, val, SYSTEM_RSVD0_RESERVED0_MASK, SYSTEM_RSVD0_RESERVED0_OFFSET)

/* SYSTEM.RSVD1 (Category: SYSTEM) */
#define READ_SYSTEM_RSVD1(base) npu_reg_read(base, REG_SYSTEM_RSVD1)
#define WRITE_SYSTEM_RSVD1(base, val) npu_reg_write(base, REG_SYSTEM_RSVD1, val)
/* SYSTEM.RSVD1.RESERVED0 (Category: SYSTEM) */
#define SYSTEM_RSVD1_RESERVED0_LEN        32
#define SYSTEM_RSVD1_RESERVED0_OFFSET     0
#define SYSTEM_RSVD1_RESERVED0_MASK_BITS  0xffffffff /* [31:0] 0b11111111111111111111111111111111 */
#define SYSTEM_RSVD1_RESERVED0_MASK       0xffffffff /* [31:0] 0b11111111111111111111111111111111 */

#define READ_SYSTEM_RSVD1_RESERVED0(base) \
    npu_reg_read_mask(base, REG_SYSTEM_RSVD1, SYSTEM_RSVD1_RESERVED0_MASK, SYSTEM_RSVD1_RESERVED0_OFFSET)
#define WRITE_SYSTEM_RSVD1_RESERVED0(base, val) \
    npu_reg_write_mask(base, REG_SYSTEM_RSVD1, val, SYSTEM_RSVD1_RESERVED0_MASK, SYSTEM_RSVD1_RESERVED0_OFFSET)

/* SYSTEM.RSVD2 (Category: SYSTEM) */
#define READ_SYSTEM_RSVD2(base) npu_reg_read(base, REG_SYSTEM_RSVD2)
#define WRITE_SYSTEM_RSVD2(base, val) npu_reg_write(base, REG_SYSTEM_RSVD2, val)
/* SYSTEM.RSVD2.RESERVED0 (Category: SYSTEM) */
#define SYSTEM_RSVD2_RESERVED0_LEN        32
#define SYSTEM_RSVD2_RESERVED0_OFFSET     0
#define SYSTEM_RSVD2_RESERVED0_MASK_BITS  0xffffffff /* [31:0] 0b11111111111111111111111111111111 */
#define SYSTEM_RSVD2_RESERVED0_MASK       0xffffffff /* [31:0] 0b11111111111111111111111111111111 */

#define READ_SYSTEM_RSVD2_RESERVED0(base) \
    npu_reg_read_mask(base, REG_SYSTEM_RSVD2, SYSTEM_RSVD2_RESERVED0_MASK, SYSTEM_RSVD2_RESERVED0_OFFSET)
#define WRITE_SYSTEM_RSVD2_RESERVED0(base, val) \
    npu_reg_write_mask(base, REG_SYSTEM_RSVD2, val, SYSTEM_RSVD2_RESERVED0_MASK, SYSTEM_RSVD2_RESERVED0_OFFSET)


#endif // __NPU_REG_SYSTEM_DX_V3_H
